...
| **[04. Hybrid Attack Chain Detection](./04-hybrid-attack-chain)** | Sysmon (EID 1), PowerShell (EID 4104), Windows Security (EID 4698) | Multi-stage correlation linking phishing initial access, obfuscated execution, and scheduled task persistence. | T1566.001, T1059.001, T1053.005 |
